...
try (// Take user Option from the following mentioned Menu
		Scanner input = new Scanner(System.in)) {
			System.out.println("Wellcome to simplilear first assissment! ");
			System.out.println("Simplilearn locckedMe.com will allow you to"
					+ " showcase endless options for you to explore your valuable products "
					+ "in the world largest market India");
			System.out.println("Prototype Application");
			
			System.out.println("Name: Tuk Adhikari");

			System.out.println("From: Ghaziabad, India");
			System.out.println("Simplilearn Full Stack Developer");
			System.out.println();
			
			do {

				System.out.println("Select File Option to perform any of the following operation:-\n");
				...
				try {
 File file = new File("C:\\Users\\user\\Desktop\\LockedMe.com//" + "input .text");
...
File directory_delete = new File("C:\\Users\\user\\Desktop\\LockedMe.com//");
...
File file = new File("C:\\Users\\user\\Desktop\\LockedMe.com//" + delete_filename);
			    if (file.delete()) {
				...
				filename = input.next();
File directory_search = new File("C:\\Users\\user\\Desktop\\LockedMe.com//");
...
File folder = new File("C:\\Users\\user\\Desktop\\LockedMe.com//");
